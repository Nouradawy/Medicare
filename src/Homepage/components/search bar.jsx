...
export default function SearchBar(text ,formData, handleChange){
    ...
    return(
        <div className="flex rounded-2xl ">
            ...
            <input className="flex max-w-[600px] w-[30vw] h-[59px] bg-[rgb(120,111,173,17%)] text-[Poppins] font-bold text-[#7B7B7B] rounded-lg   absolute z-0  pl-20 items-center justify-start " type="text" placeholder={text.text} value={formData} onChange={handleChange}/>
