...
export default function Home() {
    ...
    return (
        <div className="w-full flex flex-col min-h-screen bg-[#F5F5F5]">
            ...
            {/* Search card */}
            <div
                className={`grid grid-cols-7 gap-[4vw] w-[72.9vw] ${
                    suggestions.length < 4 && suggestions.length !== 0 ? "h-[144px]" : "h-[110px]"
                }
                bg-[#F5F5F5] absolute top-[calc(800px-50px)]
                left-[27vw] transform -translate-x-[13.54vw]
                rounded-2xl items-start justify-center pt-6 shadow-xl`}
            >
            ...
            <div className="flex-1 w-full">
                <div className="font-[Montserrat Alternates] pt-30 pl-[14vw] text-[#525252] font-medium text-xl">
                    Specialties
                </div>
                <SpecialtiesSlider
