...
export default function DefaultContent() {
    ...
    return (
        <div className="flex flex-col items-start justify-start w-full h-full">
            ...
            text-3xl 2xl:text-4xl font-normal tracking-tight  OutlineText text-[#3C63C7] pt-10">Find the right doctor</p>
            <p className="2xl:pl-[14vw] pl-[5vw]
            text-3xl 2xl:text-4xl font-normal tracking-tight OutlineText  text-[#3C63C7]">Right at your fingertips</p>
            <p className="2xl:pl-[14vw] pl-[5vw]
             w-[400px] lg:w-full
             text-lg lg:text-xl font-normal  pt-12  text-[#9C9C9C]">We care gives you the  tools and information you need to</p>

            {/*Table begins*/}
            {/*First Section*/}
            <div className="ml-[5vw] 2xl:ml-[14vw]
            ...
            <div className=" ml-[calc(5vw+30px)] 2xl:ml-[calc(14vw+30px)]
            flex mt-2 items-start">
                <svg width="2" height="100" viewBox="0 0 2 100" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <rect width="2" height="100" fill="#D9D9D9"/>
                </svg>
                <p className="ml-[50px] xl:w-[500px] w-[300px] text-[#9C9C9C] text-lg md:text-xl "> Find doctors and clinics based on the  factors
            ...
            flex mt-2 items-start">
                ...
                <p className="ml-[50px] xl:w-[500px] w-[300px] text-[#9C9C9C] text-lg md:text-xl "> Convenient schedule your appointment by phone
            ...
            <div className="ml-[calc(5vw+30px)] 2xl:ml-[calc(14vw+30px)]
            flex mt-2 items-start">
                <p className="ml-[50px] xl:w-[500px] w-[300px] text-[#9C9C9C] text-lg md:text-xl "> Learn what you need to know and which questions
