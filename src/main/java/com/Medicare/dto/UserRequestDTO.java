...
public class UserRequestDTO {
    ...
    @Schema(description = "List of chronic diseases", example = "[{\"diseaseName\": \"Diabetes\", \"description\": \"Type 2 Diabetes\"}]")
    private List<ChronicDisease> chronicDiseases;

    @Schema(description = "List of drug histories", example = "[{\"drugName\": \"Metformin\", \"description\": \"Used to treat type 2 diabetes\"}]")
