...
public interface ReservationService {
    ...
    ResponseEntity<?> updateReservationStatus(Integer id, String status, Integer totalFees);
    ResponseEntity<?> rescheduleReservation(Integer id, ReservationRequestDTO request);
}
